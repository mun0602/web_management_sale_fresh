...
print("--- Probing server endpoints ---")
test_request("server.all", "GET")
test_request("server.list", "GET")
test_request("server.one", "GET")
test_request("server.get", "GET")
test_request("server.getWebServerSettings", "GET")
test_request("settings.getWebServerSettings", "GET")
