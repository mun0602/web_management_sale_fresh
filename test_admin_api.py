...
print("--- Probing user / admin endpoints ---")
test_request("admin.all", "GET")
test_request("admin.one", "GET")
test_request("user.all", "GET")
test_request("user.one", "GET")
test_request("settings.one", "GET")
